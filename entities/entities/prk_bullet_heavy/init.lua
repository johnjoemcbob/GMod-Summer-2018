...
function ENT:PhysicsCollide( colData, collider )
	...
	self.State:Collide( self.Entity, colData.HitEntity )
	...
	local mult = 1
		-- testing/fun
		if ( colData.HitEntity:IsNPC() or colData.HitEntity:IsPlayer() ) then
			mult = 50
		end
	colData.HitEntity:TakeDamage( self.Damage * mult, self.Owner, self )
end
