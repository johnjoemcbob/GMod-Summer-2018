...
-- MODELS:
-- BASE: models/PHXtended/tri2x2x2solid.mdl
-- 		Rotated -ve X axis 90 deg, then -ve Y axis 45 deg. Might need a tool to fetch angle
-- BODY: models/props_wasteland/laundry_dryer002.mdl
-- CANNON BARREL: models/props_c17/FurnitureBoiler001a.mdl
-- CANNON BARREL END: models/props_vehicles/tire001c_car.mdl

-- MATERIALS:
-- models/debug/debugwhite

-- COLORS:
-- VARYING SHADES OF CHARCOAL

sound.Add({ 
	name = "prk_turret_fire",
	channel = CHAN_WEAPON,
	volume = 1.0,
	level = 75,
	pitch = {80, 110},
